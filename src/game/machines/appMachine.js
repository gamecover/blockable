...
export const appMachine = setup({
  ...
  states: {
    ...
    menu: { on: { START: 'prologue', CONTINUE: 'worldMap', CONTINUE_DUNGEON: 'map', CONTINUE_BATTLE: 'battle' } },
    prologue: { on: { CONTINUE: 'worldMap', MENU: 'menu' } },
    ...
    battle: { on: { WIN: 'reward', FLOOR_BOSS_WIN: 'map', DUNGEON_WIN: 'worldMap', BOSS_WIN: 'ending', LOSE: 'gameover', ABANDON: 'map', MENU: 'menu' } },
