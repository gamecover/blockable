...
export function BattleHud({ health, maxHealth, armor, gold, floor, turn, monster, placedCount, playerStatuses }) {
  return (
    <div className="battle-hud">
      <div className="battle-hud__status">
        <div className="hud-card player"><span>대장장이</span><strong>♥ {health}/{maxHealth}</strong><small>방어도 {armor} · <em>◆ {gold}</em></small><StatusEffectList statuses={playerStatuses} ownerName="대장장이" /></div>
